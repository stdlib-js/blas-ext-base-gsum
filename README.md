...
```javascript
import gsum from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gsum@v0.0.9-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-gsum/actions/workflows/test.yml/badge.svg?branch=v0.0.9
[test-url]: https://github.com/stdlib-js/blas-ext-base-gsum/actions/workflows/test.yml?query=branch:v0.0.9
